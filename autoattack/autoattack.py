...
class AutoAttack():
    def __init__(self, model, norm='Linf', eps=.3, seed=None, verbose=True,
        ...
        if not self.is_tf_model:
            ...
            self.square = SquareAttack(self.model, p_init=.8, n_queries=20000, eps=self.epsilon, norm=self.norm,
                n_restarts=5, seed=self.seed, verbose=False, device=self.device, resc_schedule=False)
